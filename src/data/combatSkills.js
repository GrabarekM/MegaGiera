...
export const PLAYER_STRIKE = Object.freeze({
  ...
  usedStat: 'strength', dice: 6, baseDamage: 0, statScaling: 1,
...
export const PLAYER_HEAVY_STRIKE = Object.freeze({
  ...
  usedStat: 'strength', dice: 10, baseDamage: 0, statScaling: 1,
...
export const WOLF_HEAVY_BITE = Object.freeze({
  ...enemyAttack('wolf_heavy_bite', 'Heavy Bite', 'A committed, powerful bite.', 3, 'strength', 6, 1, 0, ['heavy']),
  cooldown: 2,
  conditions: Object.freeze([{ fact: 'enemyHpPercent', operator: 'gt', value: 30 }]),
})
export const PEASANT_CLUB_SWING = enemyAttack('peasant_club_swing', 'Club Swing', 'A crude swing with a farm tool.', 5, 'strength', 4, 0, 1)
export const PEASANT_DESPERATE_STRIKE = enemyAttack('peasant_desperate_strike', 'Desperate Strike', 'A reckless overhead blow.', 3, 'strength', 6, 1, 0, ['heavy'])
