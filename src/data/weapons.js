...
export const WEAPON_LIST = Object.freeze([
  createWeapon({ id: 'wooden_club', displayName: 'Wooden Club', weaponType: 'Club', requiredAttribute: 'strength', requiredAttributeValue: 2, requiredProficiency: 'Mace Fighting', combatSkills: ['player_strike', 'player_heavy_strike'], description: 'A crude but dependable wooden bludgeon.' }),
  createWeapon({ id: 'broken_axe', displayName: 'Broken Axe', weaponType: 'Axe', requiredAttribute: 'strength', requiredAttributeValue: 3, requiredProficiency: 'Mace Fighting', combatSkills: ['player_strike', 'player_heavy_strike'], description: 'A damaged axe that still carries considerable weight.' }),
